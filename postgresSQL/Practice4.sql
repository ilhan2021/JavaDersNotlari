...
select * from calisanlar;--tablosu için birleşme yeri işyeri sutunu
select * from markalar;--tblosu için birleşme yeri marka_isim sutunu
...
where isyeri
in(select marka_isim from markalar where calisan_sayisi>15000);--baglantı noktası
