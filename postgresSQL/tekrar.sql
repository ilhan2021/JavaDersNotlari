...
--2) her iki tablodaki ortak id  ve isme ait kayıtları listeleyiniz
--1.yol
...
--3) personel6 tablosunda kaç farklı sehiden personel var?
select count(distinct sehir) as farkli_olan_sehirler from personel6

--4) personel6 tablosunda id'si cift sayi olan personelin tüm biliglerini listeleyiniz
--cift olanlar
--1.yol
...
--5)Personel6 tablosunda kac tane kayıt oldugunu gosteren query yazin
--1.yol
select count (id)as kayit_sayisi from personel6--(as) isteğimiz sonucu çıkaran tabloya column ismi veriyor
--2.yol
